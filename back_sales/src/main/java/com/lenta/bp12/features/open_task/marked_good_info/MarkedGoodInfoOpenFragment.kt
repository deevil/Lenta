...
class MarkedGoodInfoOpenFragment : CoreFragment<FragmentGoodInfoOpenBinding, MarkedGoodInfoOpenViewModel>(),
    ...
    override fun getViewModel(): MarkedGoodInfoOpenViewModel {
        provideViewModel(MarkedGoodInfoOpenViewModel::class.java).let {
