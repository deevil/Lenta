...
//Сохранение данных задания - НТП
public class ZmpUtzWkl08V001Rfc {

    public static final String NAME_RESOURCE = "ZMP_UTZ_WKL_08_V001_RFC";
    ...
    public ZmpUtzWkl08V001Rfc(HyperHive hyperHive) {
    ...
    public static class Param_IT_CHECK_PLACE implements Params, ConvertableToArray {
        // type: TEXT, source: {'name': 'SAP', 'type': 'C'}
        ...
        public Param_IT_CHECK_PLACE(String matnr, String statCheck) {
            this.matnr = matnr;
            this.statCheck = statCheck;

        }

        public Param_IT_CHECK_PLACE() {
        }

        @NonNull
        @Override
        public Object[] toArray() {
            return new Object[]{matnr, statCheck};
        }

        @NonNull
        @Override
        public String getParameterName() {
            return "IT_CHECK_PLACE";
        }
    }
