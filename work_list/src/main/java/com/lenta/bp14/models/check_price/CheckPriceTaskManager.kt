...
class CheckPriceTaskManager(private val timeMonitor: ITimeMonitor, private val gson: Gson, private val soundPlayer: ISoundPlayer) : ITaskManager<ICheckPriceTask, CheckPriceTaskDescription> {
