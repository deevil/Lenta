...
import com.lenta.bp10writeoff.databinding.ActivityWriteoffDetailsBindingImpl;
import com.lenta.shared.Click_ThreeBtnBotPanel;

public class WriteoffDetails extends AppCompatActivity {

    ActivityWriteoffDetailsBindingImpl binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_writeoff_details);
    ...
    public void DelBtnImg_onClick(View v)
    {
        this.finish(); //close this activity
        onBackPressed();// возврат на предыдущий activity
    }
