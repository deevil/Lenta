...
class LoadingTransmittedFragment : CoreLoadingFragment() {
    ...
    override fun getViewModel(): CoreLoadingViewModel {
        provideViewModel(LoadingTransmittedViewModel::class.java).let {
    ...
    override fun setupTopToolBar(topToolbarUiModel: TopToolbarUiModel) {
        topToolbarUiModel.description.value = getString(R.string.recounted_to_booked)
    }
