...
class LoadingStartConditionsReviseFragment : CoreLoadingFragment() {
    ...
    override fun getViewModel(): CoreLoadingViewModel {
        provideViewModel(LoadingStartConditionsReviseViewModel::class.java).let {
    ...
    override fun setupTopToolBar(topToolbarUiModel: TopToolbarUiModel) {
        (vm as? LoadingStartConditionsReviseViewModel)?.let {
