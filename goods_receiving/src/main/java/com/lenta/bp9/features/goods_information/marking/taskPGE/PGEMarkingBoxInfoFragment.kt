package com.lenta.bp9.features.goods_information.marking.taskPGE
...
class PGEMarkingBoxInfoFragment : CoreFragment<FragmentMarkingBoxInfoBinding, PGEMarkingBoxInfoViewModel>(),
    ...
    override fun getViewModel(): PGEMarkingBoxInfoViewModel {
        provideViewModel(PGEMarkingBoxInfoViewModel::class.java).let { vm ->
    ...
    companion object {
        ...
        fun newInstance(productInfo: TaskProductInfo): PGEMarkingBoxInfoFragment {
            PGEMarkingBoxInfoFragment().let {
