...
class LoadingSubmittedFragment : CoreLoadingFragment() {
    ...
    override fun getViewModel(): CoreLoadingViewModel {
        provideViewModel(LoadingSubmittedViewModel::class.java).let {
    ...
    override fun setupTopToolBar(topToolbarUiModel: TopToolbarUiModel) {
        topToolbarUiModel.description.value = getString(R.string.transmitted_to_transferred)
    }
