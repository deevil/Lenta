...
class PGEMarkingBoxInfoViewModel : BaseGoodsInfo(),  OnPositionClickListener {
    ...
    init {
        launchUITryCatch {
            ...
            searchProductDelegate.init(viewModelScope = this@PGEMarkingBoxInfoViewModel::viewModelScope,
                    scanResultHandler = this@PGEMarkingBoxInfoViewModel::handleProductSearchResult)
