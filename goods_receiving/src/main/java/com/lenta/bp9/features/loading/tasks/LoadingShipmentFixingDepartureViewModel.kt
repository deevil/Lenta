...
import com.lenta.bp9.requests.network.ZmpUtzGrz42V001NetRequest
import com.lenta.bp9.requests.network.ZmpUtzGrz42V001Params
import com.lenta.bp9.requests.network.ZmpUtzGrz42V001Result
...
class LoadingShipmentFixingDepartureViewModel : CoreLoadingViewModel() {
    ...
    @Inject
    lateinit var zmpUtzGrz42V001NetRequest: ZmpUtzGrz42V001NetRequest
    ...
    private fun handleSuccess(result: ZmpUtzGrz42V001Result) {
