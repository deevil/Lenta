...
class LoadingFinishConditionsReviseFragment : CoreLoadingFragment() {
    ...
    override fun getViewModel(): CoreLoadingViewModel {
        provideViewModel(LoadingFinishConditionsReviseViewModel::class.java).let {
    ...
    override fun setupTopToolBar(topToolbarUiModel: TopToolbarUiModel) {
        topToolbarUiModel.description.value = getString(R.string.unloading_to_unloaded)
    }
