...
import com.lenta.bp9.databinding.FragmentNonExciseAlcoInfoPgeBinding
...
class NonExciseAlcoInfoPGEFragment : CoreFragment<FragmentNonExciseAlcoInfoPgeBinding, NonExciseAlcoInfoPGEViewModel>(),
        ToolbarButtonsClickListener,
        OnScanResultListener,
        OnBackPresserListener {

    companion object {
        fun create(productInfo: TaskProductInfo, isDiscrepancy: Boolean): NonExciseAlcoInfoPGEFragment {
            NonExciseAlcoInfoPGEFragment().let {
    ...
    override fun getLayoutId(): Int = R.layout.fragment_non_excise_alco_info_pge

    override fun getPageNumber(): String = "09/19"

    override fun getViewModel(): NonExciseAlcoInfoPGEViewModel {
        provideViewModel(NonExciseAlcoInfoPGEViewModel::class.java).let { vm ->
