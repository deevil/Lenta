...
class LoadingShipmentPostingFragment : CoreLoadingFragment() {
    ...
    override fun getViewModel(): CoreLoadingViewModel {
        provideViewModel(LoadingShipmentPostingViewModel::class.java).let {vm ->
    ...
    override fun setupTopToolBar(topToolbarUiModel: TopToolbarUiModel) {
        (vm as? LoadingShipmentPostingViewModel)?.let {
