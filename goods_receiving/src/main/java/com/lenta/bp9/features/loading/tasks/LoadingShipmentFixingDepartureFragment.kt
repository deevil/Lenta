...
class LoadingShipmentFixingDepartureFragment : CoreLoadingFragment() {
    ...
    override fun getViewModel(): CoreLoadingViewModel {
        provideViewModel(LoadingShipmentFixingDepartureViewModel::class.java).let {vm ->
    ...
    override fun setupTopToolBar(topToolbarUiModel: TopToolbarUiModel) {
        (vm as? LoadingShipmentFixingDepartureViewModel)?.let {
