...
class LoadingUnloadingStartRDSFragment : CoreLoadingFragment() {
    ...
    override fun getViewModel(): CoreLoadingViewModel {
        provideViewModel(LoadingUnloadingStartRDSViewModel::class.java).let {vm ->
    ...
    override fun setupTopToolBar(topToolbarUiModel: TopToolbarUiModel) {
        (vm as? LoadingUnloadingStartRDSViewModel)?.let {
