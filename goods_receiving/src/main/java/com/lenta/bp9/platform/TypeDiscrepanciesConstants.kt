...
object TypeDiscrepanciesConstants {
    ...
    const val TYPE_DISCREPANCIES_QUALITY_DELIVERY_ERRORS = "4"
    const val TYPE_DISCREPANCIES_QUALITY_PRODUCT_QUALITY = "7"
    const val TYPE_DISCREPANCIES_QUALITY_PGE_SURPLUS = "2"
    ...
    const val TYPE_DISCREPANCIES_REASON_REJECTION_NOT_ORDER = "41"
