...
/**
 * Таблица настройки запрещенных товаров
 */
public class ZmpUtz50V001 {

    public static final String NAME_RESOURCE = "ZMP_UTZ_50_V001";
    public static final String NAME_OUT_PARAM_ET_PLANTS = "ET_EXCLUDE_MATNR";
    public static final String LIFE_TIME = "1 day, 0:00:00";

    private final HyperHive hyperHive;

    public final LocalTableResourceHelper<Item_Local_ET_EXCLUDE_MATNR, Status_ET_EXCLUDE_MATNR> localHelper_ET_EXCLUDE_MATNR;

    public ZmpUtz50V001(HyperHive hyperHive) {

        this.hyperHive = hyperHive;

        localHelper_ET_EXCLUDE_MATNR = new LocalTableResourceHelper<>(
                NAME_RESOURCE,
    ...
    static final class Status_ET_EXCLUDE_MATNR extends StatusSelectTable<Item_Local_ET_EXCLUDE_MATNR> {
    }

    public static class Item_Local_ET_EXCLUDE_MATNR {
