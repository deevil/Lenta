...
class SelectMarketFragment : CoreFragment<com.lenta.inventory.databinding.FragmentSelectMarketBinding, SelectMarketViewModel>(), ToolbarButtonsClickListener {

    override fun getLayoutId(): Int = R.layout.fragment_select_market


    override fun getPageNumber(): String = "11/03"
