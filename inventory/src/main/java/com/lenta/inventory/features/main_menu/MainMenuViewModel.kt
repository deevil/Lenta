...
class MainMenuViewModel : CoreViewModel() {
    ...
    fun onClickWorkWithTask() {
        ...
        val productInfo6 = TaskProductInfo("000000000000184076", "Виски", Uom("ST", "шт"), ProductType.ExciseAlcohol,
                true, "1", MatrixType.Active, "materialType","00", 0.0, false, isExcOld = false)
        ...
        val exciseStamp1 = TaskExciseStamp("000077", "951869302882400418200O46BLILJ3I8DPM0DV1NT3PAFZR9M13NK6CD9LOQKOE0VX143NMT2JZSTII5RQG0A5N5YVB8BG90UPAC5BTDNALGLOH9YH8SP1QV6RJ9YTFIIQAG2RFX73JKZLAM3C5060", "1", "boxNumber1", "", "", "", false)
        val exciseStamp2 = TaskExciseStamp("000077", "951869302882400418200O46BLILJ3I8DPM0DV1NT3PAFZR9M13NK6CD9LOQKOE0VX143NMT2JZSTII5RQG0A5N5YVB8BG90UPAC5BTDNALGLOH9YH8SP1QV6RJ9YTFIIQAG2RFX73JKZLAM3C5061", "1", "boxNumber2", "", "", "", false)
        val exciseStamp3 = TaskExciseStamp("000077", "22N0000154KNI691XDC380V71231001511013ZZ012345678901234567890123456ZZ", "2", "boxNumber3", "", "", "", false)
        val exciseStamp4 = TaskExciseStamp("000077", "22N0000154KNI691XDC380V71231001513730ZZ012345678901234567890123456ZZ", "2", "boxNumber3", "", "", "", false)
