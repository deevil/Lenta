...
@Inject constructor(private val hyperHive: HyperHive, private val gson: Gson) : UseCase<WriteOffReportResponse, WriteOffReport>() {
    override suspend fun run(params: WriteOffReport): Either<Failure, WriteOffReportResponse> {
        return hyperHive.requestAPI.web("ZMP_UTZ_WOB_04_V001",
                WebCallParams().apply {
